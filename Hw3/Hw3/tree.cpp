...
//  Hw3
//
//  Created by Mint MSH on 2/10/17.
...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
    ...
    int result;
    if (a1[n1-1] == a2[n2-1])
        result = countIncludes(a1, n1-1, a2, n2-1) + countIncludes(a1, n1-1, a2, n2);
    else
        result = countIncludes(a1, n1-1, a2, n2);
...
//int main()
//{
//    double a[100] = {10, 50, 40, 20, 50, 40, 30};
//    double b[100] = {50, 40, 30};
//    
//    cout << countIncludes(a, 11, b, 3) << endl;
//    
//}
