...
void listAll(const MenuItem* m, string path) // two-parameter overload
{
    ...
    if (path != "")
        cout << path << endl;
    // more than one way to implement this part
    // another way is to say
    // if (m->name() != "")
    //      cout << path << endl;
    // they work the same in this example so I am not sure
    // in my chosen case, if a file in the middle has empty name
    // it will still be printed out as "File/New/"
